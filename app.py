...
# קלטים מהמשתמש
location = st.text_input("בבקשה תזין/תזיני את קן הרוחב ראשון ולאחר מכן את קו האורך הכנס מיקום תקלה - קו אורך, קו רוחב לפי הטווחים הבאים: קו רוחב בטווח : 29.5 עד 33.3 קו ארוך בטווח: 34.2 עד 35.8")
